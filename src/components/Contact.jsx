...
const Contact = () => {
  return (
    <section id="contact" className="py-15 px-6 md:px-12 max-w-7xl mx-auto w-full border-t border-slate-200 dark:border-slate-800 transition-colors duration-500">
