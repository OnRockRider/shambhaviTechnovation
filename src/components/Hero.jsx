    ...
    <section className="relative min-h-screen flex items-center justify-center bg-[#faf9f6] dark:bg-slate-950 transition-colors duration-500 px-6 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-12 items-center justify-center min-h-screen lg:min-h-0 pt-20 lg:pt-0">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left z-20 w-full px-4 lg:px-0">
          ...
          >
            <button className="px-6 py-3 md:px-8 md:py-4 bg-slate-900 dark:bg-brandOrange text-white font-medium text-xs md:text-sm tracking-widest uppercase hover:bg-brandOrange dark:hover:bg-orange-600 transition-colors duration-300 w-full sm:w-auto">
              <a href='./contact'>
              Start a Project
              </a>
            </button>
            <button className="px-6 py-3 md:px-8 md:py-4 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-medium text-xs md:text-sm tracking-widest uppercase hover:border-slate-900 dark:hover:border-white hover:text-slate-900 dark:hover:text-white transition-colors duration-300 w-full sm:w-auto">
              <a href='./work'>
              Our Work
              </a>
            </button>
